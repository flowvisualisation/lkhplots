;+
FUNCTION FIELD_INTERP_OLD, U, V, W, x, y, z, coord
...
;
;-
PRO FIELD_LINE_OLD, U0, V0, x, y, x0, y0, xfield, yfield,step=step,$
                method=method,maxstep=maxstep,minstep=minstep,tol=tol
...
;     IF (abs(dh)/maxstep GE 1.0) THEN print,"Maximum step reached"
     ...
     IF (method EQ "RK2") THEN BEGIN  
       ...
       k1  = FIELD_INTERP_OLD(U, V, 0.0, x, y, 0.0, xk0)
       xk1 = xk0 + 0.5*dh*k1

       k2 = FIELD_INTERP_OLD(U, V, 0.0, x, y, 0.0, xk1)
       xfwd[*,k] = xk0 + dh*k2
     ENDIF
     ...
     IF (method EQ "RK4") THEN BEGIN  
       ...
       k3 = FIELD_INTERP_OLD(U, V, 0.0, x, y, 0.0, xk1)
       xk1 = xk0 + dh*k3

       k4 = FIELD_INTERP_OLD(U, V, 0.0, x, y, 0.0, xk1)
     ...
     IF (method EQ "CK45") THEN BEGIN 
       ...
       k5  = FIELD_INTERP_OLD(U, V, 0.0, x, y, 0.0, xk1)
       xk1 = xk0 + dh*(a61*k1 + a62*k2 + a63*k3 + a64*k4 + a65*k5)

       k6  = FIELD_INTERP_OLD(U, V, 0.0, x, y, 0.0, xk1)
