...
items=['B!Dx!N','B!Dy!N', 'B!Dz!N', 'b1', 'b2', 'b3','0.75' ]
...
cgplot, t, sqrt(smooth(bx2m,10)), color=colors[0], linestyle=linestyles[0],  yrange=[ymin, ymax], ystyle=1 $
    ,pos=pos $
    , xtitle="time (orbits)" $
    , xrange=[20,50]
cgplot, t, sqrt(smooth(by2m,10)), /overplot, color=colors[1], linestyle=linestyles[1]
cgplot, t, sqrt(smooth(bz2m,10)), /overplot, color=colors[2], linestyle=linestyles[2]
...
print, '1 lfast', 1/lfast
	...
	al_legend, items[0:2], colors=colors[0:2], linestyle=linestyles[0:2], charsize=1.3, /right
