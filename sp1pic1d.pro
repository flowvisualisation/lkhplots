...
expx=hist_2d(p.r(*,2,0), p.p(*,2,0), bin1=p.s.gn(2)/800., bin2=(2*vmax)/800., max2=vmax,min2=-vmax)
vmax2=1.1*max(p.p(*,2,1))
ixpx=hist_2d(p.r(*,2,1), p.p(*,2,1), bin1=p.s.gn(2)/800., bin2=(2*vmax2)/800., max2=vmax2,min2=-vmax2)
expx=alog10(expx+1e-6)
ixpx=alog10(ixpx+1e-6)
...
cgplot, xx, f.d(0,0,*,0), ytitle='ion,elec density', xtitle='xpos', pos=pos[*,2], /noerase,xstyle=1
cgplot, xx, f.d(0,0,*,1), pos=pos[*,2], /noerase, /overplot, color='red'
