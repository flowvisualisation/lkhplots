...
pos= cglayout([3,2] , OXMargin=[4,1], OYMargin=[20,6], XGap=4, YGap=9)
...
datptr(1)=ptr_new(alog10(levh1))
datptr(2)=ptr_new(fh1)
datptr(3)=ptr_new(fh1)
datptr(4)=ptr_new(alog10(levh0))
...
titstr(1)='log!D10!N|B(x,y,z='+h1tag+')|'
titstr(2)='log!D10!NB(k!Dx!N,k!Dy!N), z='+string(x3(nh1), format='(F4.2)')
titstr(3)='dummy'
titstr(4)='log!D10!NB(x,y,z='+h0tag+')|'
titstr(5)='log!D10!NB(k!Dx!N,k!Dy!N), z='+string(x3(nh0), format='(F4.2)')
...
cgplot, tnorm, bx2s , pos=[0.1,0.1,0.98,0.2], /noerase, /ylog, yrange=[1e-2*ymax,ymax], color=['red']
