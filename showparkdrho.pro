...
pos=cglayout([1,1], oxmargin=[11,10], oymargin=[12,5])
...
meanrho=total(rho,1)/nx1
meanrho2=rebin(reform(meanrho,1,nx2),nx1,nx2)
drho=rho-meanrho2
dat=alog10(abs(drho))*signum(drho)
;dat[0,0]=1
;dat[0,1]=-1.
imin=min(dat)
imax=max(dat)
...
cgloadct,5
cgimage, r, pos=px
cgcontour, drho, x1,x2, pos=pos[*,0], /nodata, /noerase, title='!8t!X='+string(t(nfile)/2./!DPI, format='(F4.1)')+' t!Dorb!N', xtitle='!8y/H!X', ytitle='!8z/H!X'
