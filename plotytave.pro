...
fname="timeaverages_az_integrated"
...
endelse
  ...
  cgcontour,xx#yy, xx,yy , /nodata, /noerase, xtitle='x', pos=p, title=titlestr(j), Charsize=cgDefCharsize()*0.5
   ...
   ENDFOR
   cgText, 0.5, 0.96, /Normal,  'Time average azimuthally integrated v!Dxyz!N,b!Dxyz!N', Alignment=0.5, Charsize=cgDefCharsize()*1.25
