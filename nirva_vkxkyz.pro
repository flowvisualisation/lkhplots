...
d=h5_read(nfile,  /v, /remap)
grd_ctl,g,c, model=nfile
bx1=transpose(reform(d.v[2,*,*,*]))
bx2=transpose(reform(d.v[1,*,*,*]))
bx3=transpose(reform(d.v[0,*,*,*]))
...
ttag=', t='+string(c.time/2.d/!DPI, format='(F7.1)')
 ...
 cgcontour, data, xx1,xx2, /xlog, /fill, nlev=64, xrange=[1,100], $
    pos=pos,$
    xtitle=xtit1,$
    ytitle="z/H",$
    title=dirtag+ttag
