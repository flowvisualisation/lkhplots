...
fh0=congrid(fh0,nx2,nx2)
fh0=smooth(fh0,qsm)

datptr=ptrarr(12)
datptr(0)=ptr_new(alog10(levh1))
datptr(1)=ptr_new(fh1)
datptr(2)=ptr_new(fh0)
datptr(3)=ptr_new(alog10(levh0))
...
readcol,'averages.dat',n,t,b2,bxby,ruxuy
tnorm=t/2.d/!DPI

ctime=t(nfile)
zz=where ( tnorm gt ctime)
lim=zz(0)
...
cgplot, tnorm, b2 , pos=[0.1,0.1,0.98,0.2], /noerase, /ylog, yrange=[1e-2*ymax,ymax], color=['red'], ytitle='B!Dx,y,z!N', xtitle='time/2'+pi_str+'  (orbits)'
