...
cgimage, r, pos=pos[*,0]
cgcontour, r,k1,k2, /nodata, /noerase, pos=pos[*,0], xtitle='k!Dx!N', ytitle='k!Dy!N', title='time='+string(time)
...
cut45[q]= smoothmyfft(nx/2+q,ny/2+q )
cut315[q]= smoothmyfft(nx/2+q,ny/2-q )
endfor

powlaw=0

cgplot, kx,kx^(powlaw)*cut45,pos=pos[*,1], /noerase, /xlog, xrange=[9e-1,125], /ylog, xtitle='k'
