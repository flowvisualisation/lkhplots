...
'pluto': begin
plutoread2, dens, vx,vy, vz,bx,by,bz, xx3d,yy3d,zz3d,xx,yy,zz,nx,ny,nz,0, time
vshear=vy
nfile=nlast
plutoread2, dens, vx,vy, vz,bx,by,bz, xx3d,yy3d,zz3d,xx,yy,zz,nx,ny,nz,nfile, time
vy=vy-vshear
