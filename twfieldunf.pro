...
if (background eq 1 ) then var(0,*,*)=vix-vixinit
if (background eq 1 ) then var(1,*,*)=viz-vizinit
...
var(3,*,*)=vex
if (background eq 1 ) then var(3,*,*)=vex-vexinit
var(3,*,*)=smooth(var(3,*,*), qsm, /edge_wrap)
var(4,*,*)=vez
if (background eq 1 ) then var(4,*,*)=vez-vezinit
...
if (i eq 2  or i eq 5) then begin
q=25
