; $Id: //depot/Release/ENVI51_IDL83/idl/idldir/lib/gauss2dfit.pro#2 $
;
...
;	CT, VIS, Oct 2013: Make sure the returned Gaussian widths are positive.
;-
...
; MODIFICATION HISTORY:
;	DMS, RSI, June, 1995.
;	MP, VIS October, 2009: Added FITA and MASK keywords.
;-
;
...
if (ISA(mask)) then begin
  ...
  zsmooth = SMOOTH(z,3, /NAN)
endelse

q = keyword_set(neg) ? MIN(zsmooth, i, /NAN) : MAX(zsmooth, i, /NAN)
ix = i mod nx
iy = i / nx
x0 = x[ix]
y0 = y[iy]
