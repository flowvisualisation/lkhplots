pro cgsix_justvort, vx1,vx2, rho, prs, t , nlast, nx1,nx2,x1,x2, background,dx1,dx2
growth=0
cg=0
hires=0
pload,0
...
!p.thick=2
velovect, cv1,cv2, cx,cy, /noerase,/overplot, position=p , color=cgcolor('white'), p_thick=6
!p.thick=1
cgloadct,33
endif
