...
COMMON  SNOOPYGRID, vx,vy, vz,bx,by,bz, xx3d,yy3d,zz3d,xx,yy,zz,nx,ny,nz, time

pro snoopyread2, nfile, dirtag
COMMON  SNOOPYGRID

fname= './'+dirtag+'/'+'data/v'+string(nfile,format='(I04)')+'.vtk'
;print,fname
...
pro sload2, nfile, dirtag
COMMON  SNOOPYGRID
snoopyread2, nfile, dirtag
end
