...
cgplot, q1,alpha1, xtitle='Shear rate, q= -dln!9W!X/dlnr', ytitle='Aspect ratio of 2D Gaussian fit', psym=psym[0], linestyle=0, xrange=[0,2], color=colors[0], yrange=[1,9], pos=[0.1,0.2,.95,.95]
...
al_legend,  items[0:1], lines=lines[0:1], color=colors[0:1], linsize=0.5, psym=psym[0:1], /right
