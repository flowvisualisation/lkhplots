...
exsm0=FFT( FFT(ex0, -1) * filter, 1 ) 
eysm0=FFT( FFT(ey0, -1) * filter, 1 ) 
ezsm0=FFT( FFT(ez0, -1) * filter, 1 ) 
...
exsm=FFT( FFT(ex, -1) * filter, 1 ) 
eysm=FFT( FFT(ey, -1) * filter, 1 ) 
ezsm=FFT( FFT(ez, -1) * filter, 1 ) 
