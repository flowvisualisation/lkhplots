...
cgplot, tnorm, (tvz2), title='Log (Total y-kinetic energy)' ,   xrange=[0.1,12],yrange=[0.01,1], xtitle='t / t!Dsound crossing!N', ytitle='Log Total y kinetic energy/KE!Dt=0!N' , /ylog, ystyle=1
...
cgplot, tnorm, 10.^(growth*t), /overplot
