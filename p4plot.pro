...
totkez=total(v2^2)/totke
totkex=total(v1^2)/totke
time=[time,i*dt]
kez=[kez,totkez]
kex=[kex,totkex]
...
legcolors=['blue','red']
cgplot, time, kez, xrange=[0.1,10], yrange=[1e-4,1], color=legcolors[0], $ 
      xtitle='time', ytitle='E', $
      linestyle=0, psym=-16, /xlog, /ylog, title='Energy', axiscolor='black' ;, position=pos
