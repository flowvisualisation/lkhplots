...
titstr=strarr(10)
titstr[0]='rho, z/H='+string(g.z(sl), format='(I3)')
titstr[1]='rho!Dlarge!N'
titstr[2]='rho!Dsmall!N'
titstr[3]='rho!Dy,large!N vs V!Dz!N'
titstr[4]='rho!Dy,small!N vs V!Dz!N'
titstr[5]='LP Filter '
titstr[6]='HP Filter '
titstr[7]='DFT B!Dy!N'
...
ytitstr[1]='y'
ytitstr[2]='y'
ytitstr[3]='rho!Dy,large!N'
ytitstr[4]='rho!Dy,small!N '
ytitstr[5]='k!Dy!N'
ytitstr[6]='k!Dy!N'
ytitstr[7]='k!Dy!N'
ytitstr[8]='k!Dy!N'
