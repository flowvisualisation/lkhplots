...
for n=0,99000,1000 do begin

path='./branches/nodielec/'
if ( file_test(path+'0000000elecxgamma'+String(n,format='(I07)') ) ne 1) then begin
print, 'File does not exist ... exiting'
break
endif
readgenps, n, 'elecxgamma', data, n1,n2
...
dispgenps2, n, 'elecxgamma', data, n1,n2,x1,x2,tit,xtit,ytit
;cgloadct,33
;tvlct,255,255,255,1
