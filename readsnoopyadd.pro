...
cgplot, tadd, sqrt(ux2m), color=colors[0], linestyle=linestyles[0], /ylog, yrange=[ymin, ymax], ystyle=1, title="MRI + PI" ;, xrange=[0,18]
cgplot, tadd, sqrt(uy2m), /overplot, color=colors[1], linestyle=linestyles[1]
cgplot, tadd, sqrt(uz2m), /overplot, color=colors[2], linestyle=linestyles[2]
cgplot, tadd, sqrt(bx2m), /overplot, color=colors[3], linestyle=linestyles[3]
cgplot, tadd, sqrt(by2m), /overplot, color=colors[4], linestyle=linestyles[4]
cgplot, tadd, sqrt(bz2m), /overplot, color=colors[5], linestyle=linestyles[5]
cgplot, tadd, sqrt(ux2m[0])*exp(0.75*t), /overplot, color=colors[6], linestyle=linestyles[6]
cgplot, tadd, abs(bzmax-0.1643751), /overplot, color=colors[5], linestyle=linestyles[5]
