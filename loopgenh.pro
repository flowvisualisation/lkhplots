...
aspect=g.ny*1./(g.nx)
cgcontour, v2m,x,y, /noerase, /nodata, title="|v|" , pos=pos[*,0] , aspect=aspect, ytitle='Y'
cgimage,cgscalevector(b2m,1,254),  pos=pos[*,1], /noerase, /keep_aspect, title='B!U2!N'
cgcontour, v2m,x,y, /noerase, /nodata, title="v!Dy!N" , pos=pos[*,1] , aspect=aspect
cgimage,cgscalevector(bxm,1,254),  pos=pos[*,2], /noerase, /keep_aspect, title='B!DX!N'
cgcontour, v2m,x,y, /noerase, /nodata, title="v!DX!N" , pos=pos[*,2] , aspect=aspect
