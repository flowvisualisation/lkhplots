...
cgcontour, d, x1,x3, /nodata, pos=pos1, color='black', /noerase, $
    ...
    xticks=3,$
    xtickinterval=1,$
    title='log!D10!N|B!U2!N|, t='+tstring, $
...
ymin=1e-3*ymax
cgplot, tnorm, b2 , pos=[0.1,0.1,0.98,0.2], /noerase, /ylog, yrange=[ymin,ymax], color=['red'], ytitle='B!Dx,y,z!N', xtitle='time/2'+pi_str+'  (orbits)', charsize=charsize
