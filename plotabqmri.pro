...
cgplot, q,alpha, xtitle='Shear rate, q= -dln!9W!X/dlnr', ytitle='Aspect ratio of 2D Gaussian fit', psym=psym[0], linestyle=0, xrange=[0,2], color=colors[0], yrange=[1,9], pos=[0.1,0.2,.95,.95]
