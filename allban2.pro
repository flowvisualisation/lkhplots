...
; pos=cglayout([2,4] , OXMargin=[9,1], OYMargin=[14,2], XGap=9, YGap=9)
 pos=cglayout([nplots/2,2] , OXMargin=[13,1], OYMargin=[9,1], XGap=4, YGap=9)
...
cgcolorbar, range=[imin,imax], pos=[px[0] , px[1]-0.03, px[2],px[1]-0.02], charsize=charsize*0.8
...
cgtext, -0.5,1.2 , "q="+string(qarr[i],format='(F4.1)'), charsize=charsize
