...
pos= cglayout([3,2] , OXMargin=[30,1], OYMargin=[30,6], XGap=7, YGap=12)
...
ymin=1e-3*ymax
;cgplot, tnorm, bx2s , pos=[0.1,0.1,0.98,0.2], /noerase, /ylog, yrange=[ymin,ymax], color=['red'], ytitle='B!Dx,y,z!N', xtitle='time/2'+pi_str+'  (orbits)', charsize=charsize

cgcontour, signum(r.by._DATA),tnorm, r.z._DATA, pos=[0.1,0.1,0.98,0.2], /noerase, /fill,nlev=32
;cgplot, tnorm, by2s , /overplot, color=['blue']
;cgplot, tnorm, bz2s , /overplot, color=['green']
cgplots, [nirvtime/2/!DPI, nirvtime/2/!DPI], [-4, 4], color='black'
