;; $Id: //depot/Release/ENVI50_IDL82/idl/idldir/lib/butterworth.pro#1 $
;;
...
FUNCTION chebyfil, xin, yin, zin, $
  ...
  t0=1
  t1=x
  tn=reform(chebypol(distarr/cutoff,order))
  ;help,tn
   rip=0.1
  bFilter = 1.0 / sqrt((1 + ( tn*rip )^2 ))
