...
;
pro twvort, nobackground=nobackground, big_endian=big_endian, lowres=lowres, zbuf=zbuf
background=0
...
velovect, cv1,cv2, cx,cy, /noerase,/overplot, position=pos , color=cgcolor('white'), thick=1.25, len=2.5
cgloadct,33
endif
endfor
