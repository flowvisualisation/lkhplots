...
cgplot, a,/xlog, /ylog, xrange=[1,200], yrange=[1e-2,1e0],  xstyle=1, $
   position=pos, $
   xtitle="wavenumber, k"
;wait,1
endfor
...
cgplot, timearr, maxfftvzarr, xtitle="Time", ytitle="max(fft(vz))", /ylog, yrange=[1e-2,max(maxfftvzarr)], ystyle=1
