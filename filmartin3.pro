...
!p.position=0
cgdisplay,xs=1200,ys=900
cgloadct,33
cgerase
pos=cglayout([4,2] , OXMargin=[7,30], OYMargin=[9,3], XGap=1, YGap=1)
...
/noerase, $
    ...
    pos=pos[*,qqi]
    cgtext, -0.9,4, titstr[qi]
    endif else begin
endelse
endfor
    
    ;; contour
    for qqi=3,8,4 do begin
qi=qqarr[qqi]
    help, xax, yax, r
datq=*datarr[qi]
r=cgscalevector(datq, 1,254)
...
yax=*yarr[qi]
px=pos[*,qqi]
posq=[px[0]*(1.05),px[1],px[2]*(1.26),px[3]]
